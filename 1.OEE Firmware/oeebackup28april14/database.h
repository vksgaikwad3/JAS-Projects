...
class dB {
    ...
    public:
		...
		void ShowTables();
		void logToCycle(string,string,string,string ,string ,string );
		void logToDownTime(string,string,string,string ,string ,string);
		string getModelName(string);
		//void logToMachine();
        /** dB Destructor */
        ~dB();
};
